...
/// <reference path="../../types/vaul.d.ts" />

import * as React from "react";

// Type declarations for "vaul" moved to: c:/laragon/www/sakusantri/types/vaul.d.ts
// This avoids "Invalid module name in augmentation" by providing an ambient
// declaration in a standalone .d.ts file instead of inside a module file.
